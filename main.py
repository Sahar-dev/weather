...
# mlflow.set_experiment("test_4")
# mlflow.sklearn.autolog(disable=True)
# # LightGBM Regressor
# with mlflow.start_run(nested=True,run_name='LGBMRegressor'):
...
#     mlflow.sklearn.log_model(model,artifact_path="ML_models_testing_4")
#     # # Register the model in the Model Registry
#     # mlflow.register_model(f'runs:/{mlflow.active_run().info.run_id}/LGBMRegressor_model', "LGBMRegressor")

# # Bernoulli Naive Bayes
# with mlflow.start_run(nested=True,run_name='BernoulliNB'):
#     model = BernoulliNB()
#     model.fit(X_train_scaled, y_train)
...
# # # CatBoost Classifier
# # with mlflow.start_run(nested=True,run_name=' CatBoostClassifier'):
